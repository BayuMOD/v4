...
data_ip="https://raw.githubusercontent.com/BayuMOD/permission/main/ip"
checking_sc() {
...
Exp=$(curl -sS https://raw.githubusercontent.com/BayuMOD/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
